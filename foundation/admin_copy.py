...
from .models import Language, AlternativeName, Country, CountryLanguage, Period, CurrencyPeriod, CountryPeriod, Demonym, \
    HistoricalPeriod, AdministrativeUnit, AdministrativeUnitType
...
class CountryAdmin(admin.ModelAdmin):
    ...
    list_display = [
        ...
        'continent',
        # country_start_year and    country_end_year are not defined in the model
        'country_start_year',
        'country_end_year',
        'created_at'
    ]
    ...
    # Add continent to the form view only
...
@admin.register(AdministrativeUnitType)
class AdministrativeUnitTypeAdmin(admin.ModelAdmin):
    list_display = ('name',)
    search_fields = ('name',)
